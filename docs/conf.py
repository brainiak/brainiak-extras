...
htmlhelp_basename = 'brainiak-extrasdoc'
...
latex_documents = [
  (master_doc, 'brainiak-extras.tex', 'BrainIAK Extras Documentation',
...
man_pages = [
    (master_doc, 'brainiak-extras', 'BrainIAK Extras Documentation',
     [author], 1)
]
...
texinfo_documents = [
  (master_doc, 'brainiak-extras', 'BrainIAK Extras Documentation',
   author, 'brainiak-extras', 'Brain Imaging Analysis Kit Extras.',
   'Miscellaneous'),
]
